...
# DRAGONFLY DATA
dragonfly_html = template.format(
    title="THE DRAGONFLY",
...
idx = idx.replace('href="https://hdmathematics.netlify.app" target="_blank" class="h70-vessel-card site-link parallax-vessel sonic-link h70-tooltip-container">\n        <div style="height: 180px; overflow: hidden; margin-bottom: 1.5rem; border-radius: 2px;">\n          <img src="assets/hdm_magnets/MaGNET_CLOPS.WEBP"', 'href="artifacts/magnet-clops.html" class="h70-vessel-card site-link parallax-vessel sonic-link h70-tooltip-container">\n        <div style="height: 180px; overflow: hidden; margin-bottom: 1.5rem; border-radius: 2px;">\n          <img src="assets/hdm_magnets/MaGNET_CLOPS.WEBP"')

idx = idx.replace('href="https://hdmathematics.netlify.app" target="_blank" class="h70-vessel-card site-link parallax-vessel sonic-link h70-tooltip-container">\n        <div style="height: 180px; overflow: hidden; margin-bottom: 1.5rem; border-radius: 2px;">\n          <img src="assets/hdm_magnets/MaGNET_GLEAM.JPEG"', 'href="artifacts/magnet-dragonfly.html" class="h70-vessel-card site-link parallax-vessel sonic-link h70-tooltip-container">\n        <div style="height: 180px; overflow: hidden; margin-bottom: 1.5rem; border-radius: 2px;">\n          <img src="assets/hdm_magnets/MaGNET_GLEAM.JPEG"')
